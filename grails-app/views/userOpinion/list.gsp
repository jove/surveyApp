    ...
    <div class="row-fluid">
   			...
   			<div class="span9">
   				...
   				<table class="table table-striped">
   					...
   					<tbody>
   					<g:each in="${userOpinionInstanceList}" var="userOpinionInstance">
   						<tr>
                            <td><g:link action="show" id="${userOpinionInstance.id}">${fieldValue(bean: userOpinionInstance, field: "submitDate")}</g:link></td>
                         	...
                         	<td>${userOpinionInstance.survey.name}</td>
   							...
   							<td class="link">
   								<g:link action="show" id="${userOpinionInstance.id}" class="btn btn-small">Show &raquo;</g:link>
   							</td>
   						</tr>
   					</g:each>
   					</tbody>
   				...
   				<div class="pagination">
   					<bootstrap:paginate total="${userOpinionInstanceTotal}" />
   				</div>
   			</div>
